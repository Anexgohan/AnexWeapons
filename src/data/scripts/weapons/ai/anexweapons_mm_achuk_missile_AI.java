...
public class anexweapons_mm_achuk_missile_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float WAVE_AMPLITUDE = 210;
    ...
    public anexweapons_mm_achuk_missile_AI(MissileAPI missile, ShipAPI launchingShip) {
