...
public class anexweapons_mm_bhairav_missile_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float WAVE_TIME = 12f;
    ...
    private final int MAX_SEARCH_RANGE = 4500;
    ...
    public anexweapons_mm_bhairav_missile_AI(MissileAPI missile, ShipAPI launchingShip) {
