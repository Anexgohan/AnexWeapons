...
public class anexweapons_mm_trishul_missile_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float OVERSHOT_ANGLE = 180;
    ...
    public anexweapons_mm_trishul_missile_AI(MissileAPI missile, ShipAPI launchingShip) {
