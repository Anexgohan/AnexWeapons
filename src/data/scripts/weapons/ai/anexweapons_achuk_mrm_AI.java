...
public class anexweapons_achuk_mrm_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public anexweapons_achuk_mrm_AI(MissileAPI missile, ShipAPI launchingShip) {
