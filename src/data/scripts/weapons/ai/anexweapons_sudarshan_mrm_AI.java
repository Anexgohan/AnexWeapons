...
public class anexweapons_sudarshan_mrm_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public anexweapons_sudarshan_mrm_AI(MissileAPI missile, ShipAPI launchingShip) {
