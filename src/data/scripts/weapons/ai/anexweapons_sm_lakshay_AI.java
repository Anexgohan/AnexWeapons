...
public class anexweapons_sm_lakshay_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public anexweapons_sm_lakshay_AI(MissileAPI missile, ShipAPI launchingShip) {
