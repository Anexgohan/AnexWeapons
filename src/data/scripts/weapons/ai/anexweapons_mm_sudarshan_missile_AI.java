...
public class anexweapons_mm_sudarshan_missile_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float OVERSHOT_ANGLE = 150;
    ...
    private final float WAVE_AMPLITUDE = 250;

    //True to enable False to disable the ECCM affecting missile waving above.
    private final boolean WAVE_ECCM_AFFECT = false;
    ...
    private float PRECISION_RANGE = 100f;
    ...
    public anexweapons_mm_sudarshan_missile_AI(MissileAPI missile, ShipAPI launchingShip) {
