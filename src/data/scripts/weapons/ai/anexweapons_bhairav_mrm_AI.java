...
public class anexweapons_bhairav_mrm_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public anexweapons_bhairav_mrm_AI(MissileAPI missile, ShipAPI launchingShip) {
