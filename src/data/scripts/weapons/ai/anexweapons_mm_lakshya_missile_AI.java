...
public class anexweapons_mm_lakshya_missile_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public anexweapons_mm_lakshya_missile_AI(MissileAPI missile, ShipAPI launchingShip) {
