...
public class anexweapons_vajra_mrm_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    public anexweapons_vajra_mrm_AI(MissileAPI missile, ShipAPI launchingShip) {
