...
public class anexweapons_mm_vajra_missile_AI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float WAVE_TIME = 2f;
    ...
    private float PRECISION_RANGE = -10f;
    ...
    public anexweapons_mm_vajra_missile_AI(MissileAPI missile, ShipAPI launchingShip) {
