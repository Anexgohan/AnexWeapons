...
public class anexweapons_mm_bhairav_missile_OnHit implements OnHitEffectPlugin {
    ...
    private static final String ARC_SOUND = "anexweapons_rocket_hit_bass_sound_01";
    //private static final float FLUXRAISE = 1000f; //depreciated
    // -- explosion graphics -------------------------------------------------
    private static final Color NEBULA_COLOR = new Color(255, 25, 94,255);
    ...
    private static final Color PARTICLE_COLOR = new Color(255, 135, 0,255);
    private static final Color GLOW_COLOR = new Color(255, 38, 0,150);
