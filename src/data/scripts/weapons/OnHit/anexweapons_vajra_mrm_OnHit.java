...
public class anexweapons_vajra_mrm_OnHit implements OnHitEffectPlugin {

    private static final Color PARTICLE_COLOR = new Color(0, 255, 255, 100);
    private static final Color BLAST_COLOR = new Color(0, 125, 255, 150);
    private static final Color CORE_COLOR = new Color(0, 255, 175, 150);
    private static final Color FLASH_COLOR = new Color(0, 75, 255, 125);
    private static final int NUM_PARTICLES = 50;
    private static final String HIT_SOUND = "anexweapons_achuk_mrm_sound_onhit";
