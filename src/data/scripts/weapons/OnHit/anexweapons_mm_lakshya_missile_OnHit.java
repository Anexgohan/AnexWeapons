...
public class anexweapons_mm_lakshya_missile_OnHit implements OnHitEffectPlugin {
    ...
    private static final String ARC_SOUND = "vpdriver_explode_before_max_range";
    //private static final float FLUXRAISE = 1000f; //depreciated
    // -- explosion graphics -------------------------------------------------
    private static final Color NEBULA_COLOR = new Color(255,0,0,225);
    ...
    private static final Color PARTICLE_COLOR = new Color(255, 89, 0,255);
    private static final Color GLOW_COLOR = new Color(255, 0, 174,255);
